...
/**
 * Classe principale pour lancer l'application d'administration des commentaires
 * JavaFX
 */
public class AdminCommentsApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            // Charger la vue d'administration des commentaires
            ...
            primaryStage.setTitle("Administration des Commentaires");
